...
function onCreate()
    ...
    makeAnimatedLuaSprite('BF_Bendy','characters/bendy/BoyFriend_NM_Bendy',getProperty('boyfriend.x'),getProperty('boyfriend.y') - 270)
...
function onStepHit()
    ...
    if difficulty ~= 0 then
        if curStep == 1355 or curStep == 2064 or curStep == 3215 and difficulty ~= 0 then
            AttackEnable = true
